...
export const ClickTrainingLevel2 = ({ onComplete }) => {
  ...
  const fallbackSpeed = 4; // Speed at which the gradient falls back
  ...
  return (
    <div className="max-w-md mx-auto text-center">
      ...
      <p className="mb-8 text-gray-700 dark:text-gray-200 transition-colors duration-300">
        Great. So you know how to click a button. Now it gets a little harder! Click the button enough times before the progress resets!
      </p>
